            ...
            <main class="flex">
                <div class="bg-gray-900 sm:w-60 min-h-screen w-14 pt-4 transition-all">
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="px-4">
                            <div class="text-gray-500 text-sm border-b border-gray-800 pb-0.5">
                                Sidebar Menu
                            </div>
                        </li>

                        <li class="hover:bg-gray-800 cursor-pointer sm:justify-start px-4 h-12 flex items-center justify-center active" @click="router.push({name:'home'})">
                        ...
                        <li class="hover:bg-gray-800 cursor-pointer sm:justify-start px-4 h-12 flex items-center justify-center" @click="router.push({name: 'users'})" v-if="auth?.user?.role == 'admin'">
                            ...
                            <span class="ml-3 hidden sm:block  text-gray-400 font-semibold tracking-wide hover:text-white transition-colors"> Users Manage</span>
                        </li>

                        <li class="hover:bg-gray-800 cursor-pointer sm:justify-start px-4 h-12 flex items-center justify-center" @click="router.push({name:'categories'})">
                            ...
                            <span class="ml-3 hidden sm:block text-gray-400 font-semibold tracking-wide hover:text-white transition-colors"> Categories</span>
                        </li>

                        <li class="hover:bg-gray-800 cursor-pointer sm:justify-start px-4 h-12 flex items-center justify-center" @click="router.push({name:'products'})">
                            ...
                            <span class="ml-3 hidden sm:block  text-gray-400 font-semibold tracking-wide hover:text-white transition-colors"> Products</span>
                        </li>

                        <li class="hover:bg-gray-800 cursor-pointer sm:justify-start px-4 h-12 flex items-center justify-center" @click="logout">

                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);"><path d="M16 13v-2H7V8l-5 4 5 4v-3z"></path><path d="M20 3h-9c-1.103 0-2 .897-2 2v4h2V5h9v14h-9v-4H9v4c0 1.103.897 2 2 2h9c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2z"></path></svg>
                            <span class="ml-3 hidden sm:block  text-gray-400 font-semibold tracking-wide hover:text-white transition-colors"> Logout</span>
                        </li>
                    </ul>
                </div>
